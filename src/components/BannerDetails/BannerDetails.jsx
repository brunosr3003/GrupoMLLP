          ...
          <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                A Multiluz Solar é uma empresa reconhecida e especializada em
                realizar instalações fotovoltaicas para residências, empresas e
                agronegócios com muita qualidade. Com uma equipe altamente
                capacitada, os melhores equipamentos e tecnologia de ponta,
                estamos prontos para ajudar você a ter o seu sistema e gerar a
                própria energia com segurança e sem dores de cabeça.
              </p>
              <div>
                <ul className="flex list-inside list-disc flex-col gap-2 md:gap-4">
                  ...
                  <li className="font-medium">
                    Equipamentos selecionados a dedo das melhores marcas a nível
                    mundial.
                  </li>
                </ul>
              </div>
